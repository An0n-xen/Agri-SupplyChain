          ...
          <ul className="navbar-nav">
              ...
              <Link to="/processor">
                <a
                  className={`nav-link text-white ${
                    dash ? "active bg-gradient-danger" : ""
                  }`}
                >
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/broadcast">
                <a
                  className={`nav-link text-white ${
                    pbroad ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/ybroadcasts">
                <a
                  className={`nav-link text-white ${
                    ybroad ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/orderDetails">
                <a
                  className={`nav-link text-white ${
                    orderDetails ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/fbroadcasts">
                <a
                  className={`nav-link text-white ${
                    fbroad ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/pInterest">
                <a
                  className={`nav-link text-white ${
                    pInterest ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/payments">
                <a
                  className={`nav-link text-white ${
                    ppayment ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/processor/status">
                <a
                  className={`nav-link text-white ${
                    status ? "active bg-gradient-danger" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
