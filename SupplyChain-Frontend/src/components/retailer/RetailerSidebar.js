...
function RetailerSidebar(props) {
  const { processorbroadcast, dash, prevorder, broadcastToCustomer, status } =
    props;
          ...
          <ul className="navbar-nav">
              ...
              <Link to="/retailer">
                <a
                  className={`nav-link text-white ${
                    dash ? "active bg-gradient-warning" : ""
                  }`}
                >
            ...
            <li className="nav-item nav-tile">
              <Link to="/retailer/processorbroadcast">
                <a
                  className={`nav-link text-white ${
                    processorbroadcast ? "active bg-gradient-warning" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item nav-tile">
              <Link to="/retailer/previousorders">
                <a
                  className={`nav-link text-white ${
                    prevorder ? "active bg-gradient-warning" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/retailer/broadcastToCustomer">
                <a
                  className={`nav-link text-white ${
                    broadcastToCustomer ? "active bg-gradient-warning" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
            ...
            <li className="nav-item nav-tile">
              <Link to="/retailer/status">
                <a
                  className={`nav-link text-white ${
                    status ? "active bg-gradient-warning" : ""
                  }`}
                >
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="material-icons opacity-10">table_view</i>
