            ...
            <div className="row align-items-center flex-row-reverse">
              <div className="col-lg-7">
                <div className="about-text go-to">
                  ...
                  <p>
                    I <mark>produce</mark> the raw materials needed to create a
                    wide range of products. I manage all activities like
                    growing, harvesting crops, raising livestocks etc. by
                    myself. I use good quality fertilisers and proper techniques
                    to grow crops.
                  </p>
